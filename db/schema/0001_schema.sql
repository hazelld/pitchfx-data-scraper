...
CREATE TABLE `games` (
  ...
  `home_losses` smallint(6) NOT NULL,
  `home_wins` smallint(6) NOT NULL,
  `home_hits` smallint(6) NOT NULL,
  `home_runs` smallint(6) NOT NULL,
  `home_errors` smallint(6) NOT NULL,
  `away_losses` smallint(6) NOT NULL,
  `away_wins` smallint(6) NOT NULL,
  `away_hits` smallint(6) NOT NULL,
  `away_runs` smallint(6) NOT NULL,
  `away_errors` smallint(6) NOT NULL,
  PRIMARY KEY (`gid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
